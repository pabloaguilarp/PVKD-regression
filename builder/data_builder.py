...
import torch
from dataloader.dataset_semantickitti import get_model_class, collate_fn_BEV, collate_fn_BEV_tta, collate_fn_BEV_ms, \
    collate_fn_BEV_ms_tta, collate_fn_BEV_reg, collate_fn_BEV_reg_tta
...
def build_regression(dataset_config,
                     train_dataloader_config,
                     val_dataloader_config,
                     grid_size=[480, 360, 32],
                     use_tta=False,
    ...
    collate_fn_BEV_tmp = collate_fn_BEV_reg
    ...
    if use_tta:
        ...
        collate_fn_BEV_tmp = collate_fn_BEV_reg_tta
    else:
        val_dataset = get_model_class(dataset_config['dataset_type'])(
            val_pt_dataset,
            grid_size=grid_size,
